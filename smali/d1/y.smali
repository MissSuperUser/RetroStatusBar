...
.field public final s:Lg1/b;

.field public t:Ld1/m;

.field public u:Z


# virtual methods
.method public declared-synchronized W()Lg1/a;
    .locals 1

    monitor-enter p0

    :try_start_0
    iget-boolean v0, p0, Ld1/y;->u:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Ld1/y;->o(Z)V

    iput-boolean v0, p0, Ld1/y;->u:Z

    :cond_0
    iget-object v0, p0, Ld1/y;->s:Lg1/b;
...
.method public declared-synchronized close()V
    ...
    invoke-interface {v0}, Lg1/b;->close()V
...
.method public final f(Ljava/io/File;Z)V
    ...
    iget-object p2, p0, Ld1/y;->o:Ljava/lang/String;

    if-eqz p2, :cond_0

    iget-object p2, p0, Ld1/y;->n:Landroid/content/Context;

    invoke-virtual {p2}, Landroid/content/Context;->getAssets()Landroid/content/res/AssetManager;

    move-result-object p2

    iget-object v0, p0, Ld1/y;->o:Ljava/lang/String;
    ...
    :cond_0
    iget-object p2, p0, Ld1/y;->p:Ljava/io/File;

    if-eqz p2, :cond_1

    new-instance p2, Ljava/io/FileInputStream;

    iget-object v0, p0, Ld1/y;->p:Ljava/io/File;
    ...
    :cond_1
    iget-object p2, p0, Ld1/y;->q:Ljava/util/concurrent/Callable;
    ...
    :goto_1
    iget-object v0, p0, Ld1/y;->n:Landroid/content/Context;
...
.method public final o(Z)V
    ...
    invoke-virtual {p0}, Ld1/y;->getDatabaseName()Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Ld1/y;->n:Landroid/content/Context;

    invoke-virtual {v2, v1}, Landroid/content/Context;->getDatabasePath(Ljava/lang/String;)Ljava/io/File;

    move-result-object v2

    iget-object v3, p0, Ld1/y;->t:Ld1/m;

    if-eqz v3, :cond_1

    iget-boolean v3, v3, Ld1/m;->k:Z
    ...
    iget-object v5, p0, Ld1/y;->n:Landroid/content/Context;

    invoke-virtual {v5}, Landroid/content/Context;->getFilesDir()Ljava/io/File;

    move-result-object v5

    invoke-direct {v4, v1, v5, v3}, Lf1/a;-><init>(Ljava/lang/String;Ljava/io/File;Z)V

    :try_start_0
    iget-object v3, v4, Lf1/a;->b:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v3}, Ljava/util/concurrent/locks/Lock;->lock()V

    iget-boolean v3, v4, Lf1/a;->c:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v5, v4, Lf1/a;->a:Ljava/io/File;
    ...
    iput-object v3, v4, Lf1/a;->d:Ljava/nio/channels/FileChannel;
    ...
    :try_start_3
    invoke-virtual {p0, v2, p1}, Ld1/y;->f(Ljava/io/File;Z)V
    :try_end_3
    .catch Ljava/io/IOException; {:try_start_3 .. :try_end_3} :catch_1
    .catchall {:try_start_3 .. :try_end_3} :catchall_0

    invoke-virtual {v4}, Lf1/a;->a()V
    ...
    :cond_4
    :try_start_5
    invoke-static {v2}, Lf1/c;->c(Ljava/io/File;)I
    ...
    :cond_5
    :try_start_7
    iget-object v7, p0, Ld1/y;->t:Ld1/m;

    invoke-virtual {v7, v3, v6}, Ld1/m;->a(II)Z
    ...
    :cond_6
    :try_start_8
    iget-object v3, p0, Ld1/y;->n:Landroid/content/Context;
