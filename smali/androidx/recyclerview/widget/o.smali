...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/recyclerview/widget/o;->r:Ljava/lang/ThreadLocal;

    new-instance v0, Landroidx/recyclerview/widget/o$a;

    invoke-direct {v0}, Landroidx/recyclerview/widget/o$a;-><init>()V

    sput-object v0, Landroidx/recyclerview/widget/o;->s:Ljava/util/Comparator;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/o;->n:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Landroidx/recyclerview/widget/o;->q:Ljava/util/ArrayList;
...
.method public a(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    iget-wide v0, p0, Landroidx/recyclerview/widget/o;->o:J
    ...
    iput-wide v0, p0, Landroidx/recyclerview/widget/o;->o:J

    invoke-virtual {p1, p0}, Landroid/view/ViewGroup;->post(Ljava/lang/Runnable;)Z

    :cond_0
    iget-object p1, p1, Landroidx/recyclerview/widget/RecyclerView;->t0:Landroidx/recyclerview/widget/o$b;
...
.method public b(J)V
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/o;->n:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Landroidx/recyclerview/widget/o;->n:Ljava/util/ArrayList;
    ...
    iget-object v5, v4, Landroidx/recyclerview/widget/RecyclerView;->t0:Landroidx/recyclerview/widget/o$b;
    ...
    :cond_1
    iget-object v2, p0, Landroidx/recyclerview/widget/o;->q:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Landroidx/recyclerview/widget/o;->n:Ljava/util/ArrayList;
    ...
    :cond_2
    iget-object v6, v5, Landroidx/recyclerview/widget/RecyclerView;->t0:Landroidx/recyclerview/widget/o$b;
    ...
    iget-object v9, p0, Landroidx/recyclerview/widget/o;->q:Ljava/util/ArrayList;
    ...
    iget-object v10, p0, Landroidx/recyclerview/widget/o;->q:Ljava/util/ArrayList;
    ...
    :cond_6
    iget-object v0, p0, Landroidx/recyclerview/widget/o;->q:Ljava/util/ArrayList;

    sget-object v2, Landroidx/recyclerview/widget/o;->s:Ljava/util/Comparator;
    ...
    :cond_9
    iget-boolean v5, v3, Landroidx/recyclerview/widget/RecyclerView;->Q:Z

    if-eqz v5, :cond_a

    iget-object v5, v3, Landroidx/recyclerview/widget/RecyclerView;->r:Landroidx/recyclerview/widget/c;
    ...
    :cond_a
    iget-object v5, v3, Landroidx/recyclerview/widget/RecyclerView;->t0:Landroidx/recyclerview/widget/o$b;
    ...
    iget-object v6, v3, Landroidx/recyclerview/widget/RecyclerView;->u0:Landroidx/recyclerview/widget/RecyclerView$y;

    iget-object v7, v3, Landroidx/recyclerview/widget/RecyclerView;->y:Landroidx/recyclerview/widget/RecyclerView$e;
...
.method public final c(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$b0;
    ...
    iget-object v3, p1, Landroidx/recyclerview/widget/RecyclerView;->r:Landroidx/recyclerview/widget/c;
    ...
    :cond_2
    iget-object v0, p1, Landroidx/recyclerview/widget/RecyclerView;->o:Landroidx/recyclerview/widget/RecyclerView$t;

    :try_start_0
    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView;->U()V

    invoke-virtual {v0, p2, v1, p3, p4}, Landroidx/recyclerview/widget/RecyclerView$t;->k(IZJ)Landroidx/recyclerview/widget/RecyclerView$b0;
    ...
    invoke-virtual {v0, p3}, Landroidx/recyclerview/widget/RecyclerView$t;->h(Landroid/view/View;)V
...
.method public run()V
    ...
    iget-object v2, p0, Landroidx/recyclerview/widget/o;->n:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, Landroidx/recyclerview/widget/o;->n:Ljava/util/ArrayList;
    ...
    iget-wide v4, p0, Landroidx/recyclerview/widget/o;->p:J
