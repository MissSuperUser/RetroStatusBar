...
.method public b(Landroidx/recyclerview/widget/RecyclerView;Z)V
    ...
    :cond_0
    iget-object v0, p1, Landroidx/recyclerview/widget/RecyclerView;->z:Landroidx/recyclerview/widget/RecyclerView$m;

    iget-object v1, p1, Landroidx/recyclerview/widget/RecyclerView;->y:Landroidx/recyclerview/widget/RecyclerView$e;

    if-eqz v1, :cond_3

    if-eqz v0, :cond_3

    iget-boolean v1, v0, Landroidx/recyclerview/widget/RecyclerView$m;->v:Z
    ...
    invoke-virtual {v0, v1, p0}, Landroidx/recyclerview/widget/RecyclerView$m;->v(ILandroidx/recyclerview/widget/RecyclerView$m$c;)V
    ...
    invoke-virtual {v0, v1, v2, v3, p0}, Landroidx/recyclerview/widget/RecyclerView$m;->u(IILandroidx/recyclerview/widget/RecyclerView$y;Landroidx/recyclerview/widget/RecyclerView$m$c;)V

    :cond_2
    :goto_0
    iget v1, p0, Landroidx/recyclerview/widget/o$b;->d:I

    iget v2, v0, Landroidx/recyclerview/widget/RecyclerView$m;->w:I

    if-le v1, v2, :cond_3

    iput v1, v0, Landroidx/recyclerview/widget/RecyclerView$m;->w:I

    iput-boolean p2, v0, Landroidx/recyclerview/widget/RecyclerView$m;->x:Z
