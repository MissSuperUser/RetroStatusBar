...
.method public constructor <init>(Landroidx/recyclerview/widget/RecyclerView;Landroid/graphics/drawable/StateListDrawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/StateListDrawable;Landroid/graphics/drawable/Drawable;III)V
    ...
    iput-object v1, p0, Landroidx/recyclerview/widget/n;->z:Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/n;->B:Ljava/lang/Runnable;
    ...
    iput v2, p0, Landroidx/recyclerview/widget/n;->e:I
    ...
    iget-object p3, p2, Landroidx/recyclerview/widget/RecyclerView;->E:Landroidx/recyclerview/widget/RecyclerView$q;

    if-ne p3, p0, :cond_1

    const/4 p3, 0x0

    iput-object p3, p2, Landroidx/recyclerview/widget/RecyclerView;->E:Landroidx/recyclerview/widget/RecyclerView$q;

    :cond_1
    iget-object p2, p0, Landroidx/recyclerview/widget/n;->s:Landroidx/recyclerview/widget/RecyclerView;

    iget-object p2, p2, Landroidx/recyclerview/widget/RecyclerView;->w0:Ljava/util/List;
...
.method public a(Landroidx/recyclerview/widget/RecyclerView;Landroid/view/MotionEvent;)Z
    ...
    iget p1, p0, Landroidx/recyclerview/widget/n;->v:I
    ...
    invoke-virtual {p0, p1, v2}, Landroidx/recyclerview/widget/n;->k(FF)Z
    ...
    invoke-virtual {p0, v2, v3}, Landroidx/recyclerview/widget/n;->j(FF)Z
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0, v1}, Landroidx/recyclerview/widget/n;->m(I)V
...
.method public c(Landroidx/recyclerview/widget/RecyclerView;Landroid/view/MotionEvent;)V
    ...
    :cond_3
    :goto_0
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/n;->m(I)V
    ...
    invoke-virtual {p0}, Landroidx/recyclerview/widget/n;->n()V

    iget p1, p0, Landroidx/recyclerview/widget/n;->w:I
    ...
    iget-object v7, p0, Landroidx/recyclerview/widget/n;->y:[I
    ...
    iget v4, p0, Landroidx/recyclerview/widget/n;->o:I
    ...
    :cond_6
    iget v5, p0, Landroidx/recyclerview/widget/n;->p:F

    iget-object v4, p0, Landroidx/recyclerview/widget/n;->s:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget v10, p0, Landroidx/recyclerview/widget/n;->q:I

    move-object v4, p0

    move v6, p1

    invoke-virtual/range {v4 .. v10}, Landroidx/recyclerview/widget/n;->l(FF[IIII)I
    ...
    iget-object v7, p0, Landroidx/recyclerview/widget/n;->x:[I

    iget p2, p0, Landroidx/recyclerview/widget/n;->b:I
    ...
    iget p2, p0, Landroidx/recyclerview/widget/n;->l:I
    ...
    :cond_9
    iget v5, p0, Landroidx/recyclerview/widget/n;->m:F
    ...
    iget v10, p0, Landroidx/recyclerview/widget/n;->r:I
...
.method public h(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$y;)V
    ...
    iget-object p3, p0, Landroidx/recyclerview/widget/n;->s:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget v3, p0, Landroidx/recyclerview/widget/n;->k:I

    div-int/lit8 v4, v3, 0x2

    sub-int/2addr v2, v4

    iget-object v4, p0, Landroidx/recyclerview/widget/n;->c:Landroid/graphics/drawable/StateListDrawable;

    invoke-virtual {v4, v0, v0, v1, v3}, Landroid/graphics/drawable/StateListDrawable;->setBounds(IIII)V

    iget-object v1, p0, Landroidx/recyclerview/widget/n;->d:Landroid/graphics/drawable/Drawable;

    iget v3, p0, Landroidx/recyclerview/widget/n;->f:I

    iget v4, p0, Landroidx/recyclerview/widget/n;->r:I
    ...
    iget-object v3, p0, Landroidx/recyclerview/widget/n;->c:Landroid/graphics/drawable/StateListDrawable;
    ...
    iget v2, p0, Landroidx/recyclerview/widget/n;->o:I

    iget v3, p0, Landroidx/recyclerview/widget/n;->n:I

    div-int/lit8 v4, v3, 0x2

    sub-int/2addr v2, v4

    iget-object v4, p0, Landroidx/recyclerview/widget/n;->g:Landroid/graphics/drawable/StateListDrawable;
    ...
    iget v3, p0, Landroidx/recyclerview/widget/n;->q:I
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/n;->h:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p3, p0, Landroidx/recyclerview/widget/n;->g:Landroid/graphics/drawable/StateListDrawable;
...
.method public final i()V
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/n;->B:Ljava/lang/Runnable;
...
.method public m(I)V
    ...
    iget-object v2, p0, Landroidx/recyclerview/widget/n;->B:Ljava/lang/Runnable;
