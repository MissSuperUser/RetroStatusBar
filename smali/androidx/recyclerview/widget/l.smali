...
.method public e(Landroidx/recyclerview/widget/RecyclerView$b0;)V
    ...
    iget-object v3, v3, Landroidx/recyclerview/widget/l$b;->a:Landroidx/recyclerview/widget/RecyclerView$b0;
    ...
    invoke-virtual {p0, v1, p1}, Landroidx/recyclerview/widget/l;->l(Ljava/util/List;Landroidx/recyclerview/widget/RecyclerView$b0;)V
    ...
    invoke-virtual {p0, v4, p1}, Landroidx/recyclerview/widget/l;->l(Ljava/util/List;Landroidx/recyclerview/widget/RecyclerView$b0;)V
    ...
    iget-object v6, v6, Landroidx/recyclerview/widget/l$b;->a:Landroidx/recyclerview/widget/RecyclerView$b0;
...
.method public f()V
    ...
    iget-object v3, v2, Landroidx/recyclerview/widget/l$b;->a:Landroidx/recyclerview/widget/RecyclerView$b0;
    ...
    iget-object v1, v2, Landroidx/recyclerview/widget/l$b;->a:Landroidx/recyclerview/widget/RecyclerView$b0;

    invoke-virtual {p0, v1}, Landroidx/recyclerview/widget/RecyclerView$j;->c(Landroidx/recyclerview/widget/RecyclerView$b0;)V
    ...
    iget-object v4, v3, Landroidx/recyclerview/widget/l$a;->a:Landroidx/recyclerview/widget/RecyclerView$b0;

    if-eqz v4, :cond_3

    invoke-virtual {p0, v3, v4}, Landroidx/recyclerview/widget/l;->m(Landroidx/recyclerview/widget/l$a;Landroidx/recyclerview/widget/RecyclerView$b0;)Z

    :cond_3
    iget-object v4, v3, Landroidx/recyclerview/widget/l$a;->b:Landroidx/recyclerview/widget/RecyclerView$b0;
    ...
    iget-object v6, v5, Landroidx/recyclerview/widget/l$b;->a:Landroidx/recyclerview/widget/RecyclerView$b0;
    ...
    iget-object v5, v5, Landroidx/recyclerview/widget/l$b;->a:Landroidx/recyclerview/widget/RecyclerView$b0;
...
.method public i(Landroidx/recyclerview/widget/RecyclerView$b0;IIII)Z
    .locals 8
    ...
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/l;->n(Landroidx/recyclerview/widget/RecyclerView$b0;)V
    ...
    invoke-direct/range {v2 .. v7}, Landroidx/recyclerview/widget/l$b;-><init>(Landroidx/recyclerview/widget/RecyclerView$b0;IIII)V
...
.method public final l(Ljava/util/List;Landroidx/recyclerview/widget/RecyclerView$b0;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v1, p2}, Landroidx/recyclerview/widget/l;->m(Landroidx/recyclerview/widget/l$a;Landroidx/recyclerview/widget/RecyclerView$b0;)Z

    move-result v2

    if-eqz v2, :cond_0

    iget-object v2, v1, Landroidx/recyclerview/widget/l$a;->a:Landroidx/recyclerview/widget/RecyclerView$b0;

    if-nez v2, :cond_0

    iget-object v2, v1, Landroidx/recyclerview/widget/l$a;->b:Landroidx/recyclerview/widget/RecyclerView$b0;
...
.method public final m(Landroidx/recyclerview/widget/l$a;Landroidx/recyclerview/widget/RecyclerView$b0;)Z
    .locals 2

    iget-object v0, p1, Landroidx/recyclerview/widget/l$a;->b:Landroidx/recyclerview/widget/RecyclerView$b0;

    const/4 v1, 0x0

    if-ne v0, p2, :cond_0

    iput-object v1, p1, Landroidx/recyclerview/widget/l$a;->b:Landroidx/recyclerview/widget/RecyclerView$b0;

    goto :goto_0

    :cond_0
    iget-object v0, p1, Landroidx/recyclerview/widget/l$a;->a:Landroidx/recyclerview/widget/RecyclerView$b0;

    if-ne v0, p2, :cond_1

    iput-object v1, p1, Landroidx/recyclerview/widget/l$a;->a:Landroidx/recyclerview/widget/RecyclerView$b0;
...
.method public final n(Landroidx/recyclerview/widget/RecyclerView$b0;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/l;->e(Landroidx/recyclerview/widget/RecyclerView$b0;)V
