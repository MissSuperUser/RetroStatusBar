...
.method public a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p1, v1, p2, v2}, Landroidx/appcompat/widget/x0;->q(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/x0;

    move-result-object p1

    invoke-virtual {p1, v2}, Landroidx/appcompat/widget/x0;->h(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/r;->a:Landroid/widget/ProgressBar;
    ...
    invoke-virtual {p0, v7, v0}, Landroidx/appcompat/widget/r;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/x0;->h(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2, v2}, Landroidx/appcompat/widget/r;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method public b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Lf0/c;->b()Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_9

    invoke-virtual {p0, v1, p2}, Landroidx/appcompat/widget/r;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-interface {v0, p2}, Lf0/c;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, Landroidx/appcompat/widget/r;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
