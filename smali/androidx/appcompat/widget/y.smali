...
.method public e(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v10, v11, v3}, Landroidx/appcompat/widget/y;->c(Landroid/content/Context;Landroidx/appcompat/widget/j;I)Landroidx/appcompat/widget/v0;

    move-result-object v3

    iput-object v3, v0, Landroidx/appcompat/widget/y;->f:Landroidx/appcompat/widget/v0;
    ...
    invoke-virtual {v14, v3, v12}, Landroidx/appcompat/widget/x0;->a(IZ)Z
    ...
    :goto_0
    invoke-virtual {v0, v10, v14}, Landroidx/appcompat/widget/y;->m(Landroid/content/Context;Landroidx/appcompat/widget/x0;)V
    ...
    invoke-virtual {v14, v4}, Landroidx/appcompat/widget/x0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v14, v4}, Landroidx/appcompat/widget/x0;->m(I)Ljava/lang/String;
    ...
    invoke-direct {v4, v10, v1}, Landroidx/appcompat/widget/x0;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    if-nez v5, :cond_e

    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/x0;->o(I)Z

    move-result v26

    if-eqz v26, :cond_e

    invoke-virtual {v4, v3, v12}, Landroidx/appcompat/widget/x0;->a(IZ)Z
    ...
    invoke-virtual {v4, v15}, Landroidx/appcompat/widget/x0;->o(I)Z

    move-result v3

    if-eqz v3, :cond_f

    invoke-virtual {v4, v15}, Landroidx/appcompat/widget/x0;->c(I)Landroid/content/res/ColorStateList;

    move-result-object v22

    :cond_f
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/x0;->o(I)Z

    move-result v3

    if-eqz v3, :cond_10

    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/x0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v4, v13}, Landroidx/appcompat/widget/x0;->o(I)Z

    move-result v3

    if-eqz v3, :cond_11

    invoke-virtual {v4, v13}, Landroidx/appcompat/widget/x0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v4, v15}, Landroidx/appcompat/widget/x0;->m(I)Ljava/lang/String;
    ...
    invoke-virtual {v4, v12}, Landroidx/appcompat/widget/x0;->o(I)Z

    move-result v19

    if-eqz v19, :cond_14

    invoke-virtual {v4, v12}, Landroidx/appcompat/widget/x0;->m(I)Ljava/lang/String;
    ...
    invoke-virtual {v4, v12, v11}, Landroidx/appcompat/widget/x0;->f(II)I
    ...
    :cond_16
    :goto_8
    invoke-virtual {v0, v10, v4}, Landroidx/appcompat/widget/y;->m(Landroid/content/Context;Landroidx/appcompat/widget/x0;)V
    ...
    invoke-virtual {v4, v10, v12}, Landroidx/appcompat/widget/j;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_3c
    :goto_1c
    iget-object v4, v0, Landroidx/appcompat/widget/y;->a:Landroid/widget/TextView;
    ...
    invoke-static {v10, v3}, Lc0/a;->c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_46
    instance-of v4, v2, Lo0/j;

    if-eqz v4, :cond_47

    check-cast v2, Lo0/j;

    invoke-interface {v2, v3}, Lo0/j;->setSupportCompoundDrawablesTintList(Landroid/content/res/ColorStateList;)V
    ...
    :cond_48
    instance-of v4, v3, Lo0/j;

    if-eqz v4, :cond_49

    check-cast v3, Lo0/j;

    invoke-interface {v3, v2}, Lo0/j;->setSupportCompoundDrawablesTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {v1, v2}, Lo0/h;->b(Landroid/widget/TextView;I)V
    ...
    invoke-static {v1, v4}, Lo0/h;->c(Landroid/widget/TextView;I)V
    ...
    invoke-static {v1, v5}, Lo0/h;->d(Landroid/widget/TextView;I)V
...
.method public f(Landroid/content/Context;I)V
    ...
    :cond_4
    invoke-virtual {p0, p1, v1}, Landroidx/appcompat/widget/y;->m(Landroid/content/Context;Landroidx/appcompat/widget/x0;)V
...
.method public g(Landroid/widget/TextView;Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;)V
    ...
    invoke-static {p3, p1, v2, v0}, Ln0/a;->b(Landroid/view/inputmethod/EditorInfo;Ljava/lang/CharSequence;II)V
    ...
    invoke-static {p1, v2, p2}, Ln0/a;->a(Ljava/lang/CharSequence;II)Z
    ...
    invoke-static {p1, v7, v6}, Ln0/a;->a(Ljava/lang/CharSequence;II)Z
    ...
    invoke-static {p3, p1, v5, v3}, Ln0/a;->b(Landroid/view/inputmethod/EditorInfo;Ljava/lang/CharSequence;II)V

    goto :goto_7

    :cond_d
    :goto_6
    invoke-static {p3, v3, p2, p2}, Ln0/a;->b(Landroid/view/inputmethod/EditorInfo;Ljava/lang/CharSequence;II)V
...
.method public final m(Landroid/content/Context;Landroidx/appcompat/widget/x0;)V
    .locals 10
    ...
    invoke-virtual {p2, v5, p1, v9}, Landroidx/appcompat/widget/x0;->i(IILd0/g$c;)Landroid/graphics/Typeface;
