...
.field public d0:Landroidx/appcompat/widget/m;

.field public e0:Landroidx/appcompat/widget/SwitchCompat$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/widget/SwitchCompat;->g0:Landroid/util/Property;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v11, v7, Landroidx/appcompat/widget/SwitchCompat;->o:Landroid/content/res/ColorStateList;

    iput-object v11, v7, Landroidx/appcompat/widget/SwitchCompat;->p:Landroid/graphics/PorterDuff$Mode;

    const/4 v12, 0x0

    iput-boolean v12, v7, Landroidx/appcompat/widget/SwitchCompat;->q:Z

    iput-boolean v12, v7, Landroidx/appcompat/widget/SwitchCompat;->r:Z

    iput-object v11, v7, Landroidx/appcompat/widget/SwitchCompat;->t:Landroid/content/res/ColorStateList;

    iput-object v11, v7, Landroidx/appcompat/widget/SwitchCompat;->u:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v12, v7, Landroidx/appcompat/widget/SwitchCompat;->v:Z

    iput-boolean v12, v7, Landroidx/appcompat/widget/SwitchCompat;->w:Z

    invoke-static {}, Landroid/view/VelocityTracker;->obtain()Landroid/view/VelocityTracker;

    move-result-object v0

    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->K:Landroid/view/VelocityTracker;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->f0:Landroid/graphics/Rect;

    invoke-virtual/range {p0 .. p0}, Landroid/widget/CompoundButton;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-static {v7, v0}, Landroidx/appcompat/widget/s0;->a(Landroid/view/View;Landroid/content/Context;)V
    ...
    iput-object v13, v7, Landroidx/appcompat/widget/SwitchCompat;->U:Landroid/text/TextPaint;
    ...
    sget-object v2, Le/n;->x:[I

    new-instance v15, Landroidx/appcompat/widget/x0;
    ...
    invoke-direct {v15, v8, v6}, Landroidx/appcompat/widget/x0;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
    ...
    invoke-static/range {v0 .. v6}, Ll0/w;->u(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V

    const/4 v0, 0x2

    invoke-virtual {v15, v0}, Landroidx/appcompat/widget/x0;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iput-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->n:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->s:Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    invoke-virtual {v15, v12}, Landroidx/appcompat/widget/x0;->n(I)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-direct {v7, v1}, Landroidx/appcompat/widget/SwitchCompat;->setTextOnInternal(Ljava/lang/CharSequence;)V

    invoke-virtual {v15, v14}, Landroidx/appcompat/widget/x0;->n(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v15, v1, v14}, Landroidx/appcompat/widget/x0;->a(IZ)Z

    move-result v2

    iput-boolean v2, v7, Landroidx/appcompat/widget/SwitchCompat;->F:Z

    const/16 v2, 0x8

    invoke-virtual {v15, v2, v12}, Landroidx/appcompat/widget/x0;->f(II)I
    ...
    iput v2, v7, Landroidx/appcompat/widget/SwitchCompat;->z:I

    const/4 v2, 0x4

    invoke-virtual {v15, v2, v12}, Landroidx/appcompat/widget/x0;->a(IZ)Z

    move-result v2

    iput-boolean v2, v7, Landroidx/appcompat/widget/SwitchCompat;->A:Z

    const/16 v2, 0x9

    invoke-virtual {v15, v2}, Landroidx/appcompat/widget/x0;->c(I)Landroid/content/res/ColorStateList;

    move-result-object v2

    if-eqz v2, :cond_2

    iput-object v2, v7, Landroidx/appcompat/widget/SwitchCompat;->o:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v15, v2, v3}, Landroidx/appcompat/widget/x0;->j(II)I

    move-result v2

    invoke-static {v2, v11}, Landroidx/appcompat/widget/e0;->e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v2

    iget-object v4, v7, Landroidx/appcompat/widget/SwitchCompat;->p:Landroid/graphics/PorterDuff$Mode;

    if-eq v4, v2, :cond_3

    iput-object v2, v7, Landroidx/appcompat/widget/SwitchCompat;->p:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v14, v7, Landroidx/appcompat/widget/SwitchCompat;->r:Z
    ...
    iget-boolean v2, v7, Landroidx/appcompat/widget/SwitchCompat;->r:Z
    ...
    iput-object v2, v7, Landroidx/appcompat/widget/SwitchCompat;->t:Landroid/content/res/ColorStateList;
    ...
    iget-object v4, v7, Landroidx/appcompat/widget/SwitchCompat;->u:Landroid/graphics/PorterDuff$Mode;

    if-eq v4, v2, :cond_7

    iput-object v2, v7, Landroidx/appcompat/widget/SwitchCompat;->u:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v14, v7, Landroidx/appcompat/widget/SwitchCompat;->w:Z
    ...
    iget-boolean v2, v7, Landroidx/appcompat/widget/SwitchCompat;->w:Z
    ...
    invoke-virtual {v15, v2, v12}, Landroidx/appcompat/widget/x0;->l(II)I

    move-result v2

    if-eqz v2, :cond_16

    sget-object v4, Le/n;->y:[I
    ...
    invoke-static {v8, v4}, Lc0/a;->c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :goto_1
    iput-object v4, v7, Landroidx/appcompat/widget/SwitchCompat;->V:Landroid/content/res/ColorStateList;
    ...
    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->b0:Landroid/text/method/TransformationMethod;

    goto :goto_7

    :cond_15
    iput-object v11, v7, Landroidx/appcompat/widget/SwitchCompat;->b0:Landroid/text/method/TransformationMethod;

    :goto_7
    iget-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->B:Ljava/lang/CharSequence;

    invoke-direct {v7, v0}, Landroidx/appcompat/widget/SwitchCompat;->setTextOnInternal(Ljava/lang/CharSequence;)V

    iget-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->D:Ljava/lang/CharSequence;
    ...
    invoke-direct {v0, v7}, Landroidx/appcompat/widget/y;-><init>(Landroid/widget/TextView;)V

    invoke-virtual {v0, v9, v10}, Landroidx/appcompat/widget/y;->e(Landroid/util/AttributeSet;I)V
    ...
    iput v1, v7, Landroidx/appcompat/widget/SwitchCompat;->H:I
...
.method private getEmojiTextViewHelper()Landroidx/appcompat/widget/m;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->d0:Landroidx/appcompat/widget/m;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->d0:Landroidx/appcompat/widget/m;
...
.method private getThumbOffset()I
    ...
    invoke-static {p0}, Landroidx/appcompat/widget/f1;->b(Landroid/view/View;)Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->f0:Landroid/graphics/Rect;
...
.method public final f()V
    ...
    invoke-direct {v2, v4, v3, v5, v1}, Ll0/u;-><init>(ILjava/lang/Class;II)V

    invoke-virtual {v2, p0, v0}, Ll0/w$b;->e(Landroid/view/View;Ljava/lang/Object;)V
...
.method public final h()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->e0:Landroidx/appcompat/widget/SwitchCompat$b;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->e0:Landroidx/appcompat/widget/SwitchCompat$b;
...
.method public onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->f0:Landroid/graphics/Rect;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v1, p0, Landroidx/appcompat/widget/SwitchCompat;->I:F
    ...
    iget v3, p0, Landroidx/appcompat/widget/SwitchCompat;->I:F
    ...
    iget v3, p0, Landroidx/appcompat/widget/SwitchCompat;->J:F
    ...
    :cond_9
    iput v5, p0, Landroidx/appcompat/widget/SwitchCompat;->G:I
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->n:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/SwitchCompat;->f0:Landroid/graphics/Rect;
    ...
    iget v8, p0, Landroidx/appcompat/widget/SwitchCompat;->T:I
...
.method public setChecked(Z)V
    ...
    :goto_1
    sget-object p1, Landroidx/appcompat/widget/SwitchCompat;->g0:Landroid/util/Property;
