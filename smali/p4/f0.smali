...
# direct methods
.method public constructor <init>(Lp4/h0;Landroid/content/Context;)V
    .locals 0

    iput-object p1, p0, Lp4/f0;->c:Lp4/h0;

    iput-object p2, p0, Lp4/f0;->b:Landroid/content/Context;
...
.method public final bridge synthetic a()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lp4/f0;->b:Landroid/content/Context;

    const-string v1, "mobile_ads_settings"

    invoke-static {v0, v1}, Lp4/h0;->b(Landroid/content/Context;Ljava/lang/String;)V

    new-instance v0, Lp4/m2;

    invoke-direct {v0}, Lp4/m2;-><init>()V
...
.method public final b(Lp4/h1;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v1, v0}, Lp4/h1;->J(Ln4/a;I)Lp4/n1;
...
.method public final c()Ljava/lang/Object;
    ...
    const-string v5, "com.google.android.gms.ads.ChimeraMobileAdsSettingManagerCreatorImpl"
    :try_end_0
    ...
    :cond_0
    const-string v5, "com.google.android.gms.ads.internal.client.IMobileAdsSettingManagerCreator"

    invoke-interface {v0, v5}, Landroid/os/IBinder;->queryLocalInterface(Ljava/lang/String;)Landroid/os/IInterface;

    move-result-object v5

    instance-of v6, v5, Lp4/o1;

    if-eqz v6, :cond_1

    check-cast v5, Lp4/o1;
    ...
    :cond_1
    new-instance v5, Lp4/o1;

    invoke-direct {v5, v0}, Lp4/o1;-><init>(Landroid/os/IBinder;)V
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_0

    :goto_0
    :try_start_3
    invoke-virtual {v5, v4, v2}, Lp4/o1;->S1(Ln4/a;I)Landroid/os/IBinder;
    ...
    instance-of v2, v1, Lp4/n1;

    if-eqz v2, :cond_3

    check-cast v1, Lp4/n1;
    ...
    invoke-direct {v1, v0}, Lp4/l1;-><init>(Landroid/os/IBinder;)V
    :try_end_3
    ...
    :goto_3
    iget-object v1, p0, Lp4/f0;->c:Lp4/h0;

    iget-object v2, p0, Lp4/f0;->b:Landroid/content/Context;
    ...
    :cond_4
    iget-object v0, p0, Lp4/f0;->c:Lp4/h0;

    iget-object v0, v0, Lp4/h0;->c:Ljava/lang/Object;

    check-cast v0, Lp4/i2;

    iget-object v4, p0, Lp4/f0;->b:Landroid/content/Context;
    ...
    invoke-virtual {v0, v5, v2}, Lp4/o1;->S1(Ln4/a;I)Landroid/os/IBinder;
