...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lb1/d;->L:Ljava/util/Set;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v1, p1, Landroidx/preference/MultiSelectListPreference;->g0:[Ljava/lang/CharSequence;

    if-eqz v1, :cond_0

    iget-object v1, p1, Landroidx/preference/MultiSelectListPreference;->h0:[Ljava/lang/CharSequence;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lb1/d;->L:Ljava/util/Set;

    invoke-interface {v1}, Ljava/util/Set;->clear()V

    iget-object v1, p0, Lb1/d;->L:Ljava/util/Set;

    iget-object v2, p1, Landroidx/preference/MultiSelectListPreference;->i0:Ljava/util/Set;

    invoke-interface {v1, v2}, Ljava/util/Set;->addAll(Ljava/util/Collection;)Z

    iput-boolean v0, p0, Lb1/d;->M:Z

    iget-object v0, p1, Landroidx/preference/MultiSelectListPreference;->g0:[Ljava/lang/CharSequence;

    iput-object v0, p0, Lb1/d;->N:[Ljava/lang/CharSequence;

    iget-object p1, p1, Landroidx/preference/MultiSelectListPreference;->h0:[Ljava/lang/CharSequence;

    iput-object p1, p0, Lb1/d;->O:[Ljava/lang/CharSequence;
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Lb1/d;->N:[Ljava/lang/CharSequence;

    const-string v1, "MultiSelectListPreferenceDialogFragmentCompat.entries"

    invoke-virtual {p1, v1, v0}, Landroid/os/Bundle;->putCharSequenceArray(Ljava/lang/String;[Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lb1/d;->O:[Ljava/lang/CharSequence;
...
.method public s(Z)V
    ...
    iget-object v0, p0, Lb1/d;->L:Ljava/util/Set;

    invoke-virtual {p1, v0}, Landroidx/preference/Preference;->j(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p1, v0}, Landroidx/preference/MultiSelectListPreference;->T(Ljava/util/Set;)V

    :cond_0
    const/4 p1, 0x0

    iput-boolean p1, p0, Lb1/d;->M:Z
...
.method public t(Landroidx/appcompat/app/d$a;)V
    ...
    iget-object v3, p0, Lb1/d;->L:Ljava/util/Set;

    iget-object v4, p0, Lb1/d;->O:[Ljava/lang/CharSequence;
    ...
    new-instance v2, Lb1/d$a;

    invoke-direct {v2, p0}, Lb1/d$a;-><init>(Lb1/d;)V
