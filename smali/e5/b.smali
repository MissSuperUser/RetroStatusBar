...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2}, Le5/d;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    const/4 p1, -0x1

    iput p1, p0, Le5/b;->f:I

    iput p1, p0, Le5/b;->h:I
...
.method public g(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget v5, p0, Le5/b;->h:I

    if-le v1, v5, :cond_3

    iput v0, p0, Le5/b;->g:I
    ...
    :goto_2
    iput-boolean p1, p0, Le5/b;->e:Z

    if-eqz p1, :cond_8

    iput v1, p0, Le5/b;->g:I
    ...
    iget-object p1, p0, Le5/b;->i:Landroid/view/VelocityTracker;
    ...
    iput-object p1, p0, Le5/b;->i:Landroid/view/VelocityTracker;

    :cond_7
    iget-object p1, p0, Le5/b;->d:Landroid/widget/OverScroller;
...
.method public r(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iput v0, v6, Le5/b;->g:I

    goto :goto_1

    :cond_2
    iget v0, v6, Le5/b;->f:I
    ...
    :cond_4
    iget-object v0, v6, Le5/b;->i:Landroid/view/VelocityTracker;
    ...
    iget-object v11, v6, Le5/b;->c:Ljava/lang/Runnable;

    if-eqz v11, :cond_5

    invoke-virtual {v2, v11}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iput-object v3, v6, Le5/b;->c:Ljava/lang/Runnable;

    :cond_5
    iget-object v11, v6, Le5/b;->d:Landroid/widget/OverScroller;
    ...
    iput-object v11, v6, Le5/b;->d:Landroid/widget/OverScroller;
    ...
    iget-object v0, v6, Le5/b;->d:Landroid/widget/OverScroller;
    ...
    invoke-direct {v0, v6, v1, v2}, Le5/b$a;-><init>(Le5/b;Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;)V

    iput-object v0, v6, Le5/b;->c:Ljava/lang/Runnable;

    sget-object v1, Ll0/w;->a:Ljava/util/WeakHashMap;

    invoke-static {v2, v0}, Ll0/w$d;->m(Landroid/view/View;Ljava/lang/Runnable;)V
    ...
    :goto_3
    iput-boolean v9, v6, Le5/b;->e:Z

    iput v4, v6, Le5/b;->f:I

    iget-object v1, v6, Le5/b;->i:Landroid/view/VelocityTracker;

    if-eqz v1, :cond_a

    invoke-virtual {v1}, Landroid/view/VelocityTracker;->recycle()V

    iput-object v3, v6, Le5/b;->i:Landroid/view/VelocityTracker;
...
.method public final w(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)I
    ...
    invoke-virtual/range {v1 .. v6}, Le5/b;->y(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)I
...
.method public x(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)I
    ...
    invoke-virtual/range {v0 .. v5}, Le5/b;->y(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)I
