...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Le5/c;->c:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Le5/c;->d:Landroid/graphics/Rect;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Le5/c;->c:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Le5/c;->d:Landroid/graphics/Rect;
...
.method public i(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;IIII)Z
    ...
    invoke-static {v2}, Ll0/w$d;->b(Landroid/view/View;)Z

    move-result v3

    if-eqz v3, :cond_2

    invoke-virtual {p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->getLastWindowInsets()Ll0/f0;

    move-result-object v3

    if-eqz v3, :cond_2

    invoke-virtual {v3}, Ll0/f0;->e()I

    move-result v4

    invoke-virtual {v3}, Ll0/f0;->b()I
...
.method public t(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)V
    ...
    iget-object v5, p0, Le5/c;->c:Landroid/graphics/Rect;
    ...
    :cond_0
    iget-object p1, p0, Le5/c;->d:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v0}, Le5/c;->v(Landroid/view/View;)I
...
.method public final v(Landroid/view/View;)I
    ...
    invoke-static {v0, v1, p1}, Le/k;->a(III)I
