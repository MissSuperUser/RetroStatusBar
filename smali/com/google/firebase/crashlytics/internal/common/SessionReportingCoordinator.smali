...
.method public static synthetic a(Lcom/google/firebase/crashlytics/internal/common/SessionReportingCoordinator;Lb5/i;)Z
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/firebase/crashlytics/internal/common/SessionReportingCoordinator;->onReportSendComplete(Lb5/i;)Z
...
.method private static getSortedCustomAttributes(Ljava/util/Map;)Ljava/util/List;
    ...
    :cond_0
    sget-object p0, Lcom/google/firebase/crashlytics/internal/common/c;->a:Lcom/google/firebase/crashlytics/internal/common/c;
...
.method private onReportSendComplete(Lb5/i;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public sendReports(Ljava/util/concurrent/Executor;)Lb5/i;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v3, v2}, Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;->sendReport(Lcom/google/firebase/crashlytics/internal/common/CrashlyticsReportWithSessionId;)Lb5/i;

    move-result-object v2

    new-instance v3, Ld1/h;

    invoke-direct {v3, p0}, Ld1/h;-><init>(Lcom/google/firebase/crashlytics/internal/common/SessionReportingCoordinator;)V

    invoke-virtual {v2, p1, v3}, Lb5/i;->f(Ljava/util/concurrent/Executor;Lb5/a;)Lb5/i;
    ...
    :cond_0
    invoke-static {v1}, Lb5/l;->f(Ljava/util/Collection;)Lb5/i;
