...
.field public T:Lz5/f;

.field public T0:Z

.field public U:Lz5/i;

.field public final U0:Ls5/c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, v0}, Ld6/l;-><init>(Lcom/google/android/material/textfield/TextInputLayout;)V

    iput-object v1, v0, Lcom/google/android/material/textfield/TextInputLayout;->v:Ld6/l;
    ...
    invoke-direct {v1, v0}, Ls5/c;-><init>(Landroid/view/View;)V

    iput-object v1, v0, Lcom/google/android/material/textfield/TextInputLayout;->U0:Ls5/c;
    ...
    sget-object v2, Ld5/a;->a:Landroid/animation/TimeInterpolator;

    iput-object v2, v1, Ls5/c;->I:Landroid/animation/TimeInterpolator;

    invoke-virtual {v1}, Ls5/c;->j()V

    iput-object v2, v1, Ls5/c;->H:Landroid/animation/TimeInterpolator;

    invoke-virtual {v1}, Ls5/c;->j()V

    const v2, 0x800033

    invoke-virtual {v1, v2}, Ls5/c;->m(I)V

    sget-object v3, Lc5/a;->H:[I
    ...
    invoke-static {v13, v7, v9, v8}, Ls5/p;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    const v16, 0x7f130348

    const v17, 0x7f0404bc
    ...
    invoke-direct {v1, v13, v2}, Landroidx/appcompat/widget/x0;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    const/16 v3, 0x29

    invoke-virtual {v1, v3, v14}, Landroidx/appcompat/widget/x0;->a(IZ)Z
    ...
    invoke-virtual {v1, v4, v10}, Landroidx/appcompat/widget/x0;->f(II)I
    ...
    invoke-direct {v5, v6}, Lz5/a;-><init>(F)V

    invoke-static {v13, v7, v9, v8, v5}, Lz5/i;->b(Landroid/content/Context;Landroid/util/AttributeSet;IILz5/c;)Lz5/i$b;
    ...
    iput-object v5, v0, Lcom/google/android/material/textfield/TextInputLayout;->U:Lz5/i;
    ...
    invoke-virtual {v1, v5, v11}, Landroidx/appcompat/widget/x0;->e(II)I
    ...
    invoke-virtual {v1, v5, v6}, Landroidx/appcompat/widget/x0;->f(II)I
    ...
    invoke-virtual {v1, v5, v6}, Landroidx/appcompat/widget/x0;->d(IF)F

    move-result v5

    const/16 v7, 0xa

    invoke-virtual {v1, v7, v6}, Landroidx/appcompat/widget/x0;->d(IF)F

    move-result v7

    const/16 v8, 0x8

    invoke-virtual {v1, v8, v6}, Landroidx/appcompat/widget/x0;->d(IF)F

    move-result v9

    const/16 v3, 0x9

    invoke-virtual {v1, v3, v6}, Landroidx/appcompat/widget/x0;->d(IF)F

    move-result v3

    iget-object v6, v0, Lcom/google/android/material/textfield/TextInputLayout;->U:Lz5/i;

    invoke-static {v6}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    new-instance v8, Lz5/i$b;

    invoke-direct {v8, v6}, Lz5/i$b;-><init>(Lz5/i;)V
    ...
    invoke-virtual {v8, v5}, Lz5/i$b;->f(F)Lz5/i$b;
    ...
    invoke-virtual {v8, v7}, Lz5/i$b;->g(F)Lz5/i$b;
    ...
    invoke-virtual {v8, v9}, Lz5/i$b;->e(F)Lz5/i$b;
    ...
    invoke-virtual {v8, v3}, Lz5/i$b;->d(F)Lz5/i$b;

    :cond_5
    invoke-virtual {v8}, Lz5/i$b;->a()Lz5/i;

    move-result-object v3

    iput-object v3, v0, Lcom/google/android/material/textfield/TextInputLayout;->U:Lz5/i;

    const/4 v3, 0x5

    invoke-static {v13, v1, v3}, Lw5/c;->b(Landroid/content/Context;Landroidx/appcompat/widget/x0;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v13, v3}, Lc0/a;->c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :goto_1
    invoke-virtual {v1, v14}, Landroidx/appcompat/widget/x0;->o(I)Z

    move-result v3

    if-eqz v3, :cond_8

    invoke-virtual {v1, v14}, Landroidx/appcompat/widget/x0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v1, v3, v11}, Landroidx/appcompat/widget/x0;->b(II)I
    ...
    invoke-static {v13, v3}, Lc0/a;->b(Landroid/content/Context;I)I
    ...
    invoke-virtual {v1, v3, v10}, Landroidx/appcompat/widget/x0;->l(II)I

    move-result v5

    if-eq v5, v10, :cond_b

    invoke-virtual {v1, v3, v11}, Landroidx/appcompat/widget/x0;->l(II)I
    ...
    invoke-virtual {v1, v6, v11}, Landroidx/appcompat/widget/x0;->a(IZ)Z
    ...
    invoke-static {v13}, Lw5/c;->d(Landroid/content/Context;)Z
    ...
    invoke-static {v13, v1, v8}, Lw5/c;->b(Landroid/content/Context;Landroidx/appcompat/widget/x0;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v1, v8, v10}, Landroidx/appcompat/widget/x0;->j(II)I

    move-result v8

    invoke-static {v8, v14}, Ls5/t;->d(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    sget-object v8, Ll0/w;->a:Ljava/util/WeakHashMap;

    invoke-static {v7, v4}, Ll0/w$d;->s(Landroid/view/View;I)V
    ...
    invoke-virtual {v1, v8, v11}, Landroidx/appcompat/widget/x0;->l(II)I

    move-result v8

    const/16 v14, 0x25

    invoke-virtual {v1, v14, v11}, Landroidx/appcompat/widget/x0;->a(IZ)Z

    move-result v14

    const/16 v4, 0x24

    invoke-virtual {v1, v4}, Landroidx/appcompat/widget/x0;->n(I)Ljava/lang/CharSequence;

    move-result-object v4

    const/16 v10, 0x32

    invoke-virtual {v1, v10, v11}, Landroidx/appcompat/widget/x0;->l(II)I

    move-result v10

    const/16 v11, 0x31

    invoke-virtual {v1, v11}, Landroidx/appcompat/widget/x0;->n(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, v2, v10}, Landroidx/appcompat/widget/x0;->l(II)I
    ...
    invoke-virtual {v1, v2, v10}, Landroidx/appcompat/widget/x0;->a(IZ)Z
    ...
    invoke-virtual {v1, v10, v2}, Landroidx/appcompat/widget/x0;->j(II)I
    ...
    invoke-virtual {v1, v10, v11}, Landroidx/appcompat/widget/x0;->a(IZ)Z
    ...
    invoke-static {v13, v1, v10}, Lw5/c;->b(Landroid/content/Context;Landroidx/appcompat/widget/x0;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v1, v10, v11}, Landroidx/appcompat/widget/x0;->j(II)I

    move-result v10

    const/4 v11, 0x0

    invoke-static {v10, v11}, Ls5/t;->d(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-direct {v10, v0, v3}, Ld6/e;-><init>(Lcom/google/android/material/textfield/TextInputLayout;I)V

    const/4 v11, -0x1

    invoke-virtual {v12, v11, v10}, Landroid/util/SparseArray;->append(ILjava/lang/Object;)V

    new-instance v10, Ld6/o;

    invoke-direct {v10, v0}, Ld6/o;-><init>(Lcom/google/android/material/textfield/TextInputLayout;)V
    ...
    invoke-virtual {v1, v6, v11}, Landroidx/appcompat/widget/x0;->l(II)I
    ...
    invoke-virtual {v1, v3, v6}, Landroidx/appcompat/widget/x0;->j(II)I
    ...
    invoke-virtual {v1, v3, v6}, Landroidx/appcompat/widget/x0;->a(IZ)Z
    ...
    invoke-virtual {v1, v10, v3}, Landroidx/appcompat/widget/x0;->a(IZ)Z
    ...
    invoke-static {v3, v6}, Ls5/t;->d(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v1, v6}, Landroidx/appcompat/widget/x0;->o(I)Z

    move-result v3

    if-eqz v3, :cond_1b

    invoke-static {v13, v1, v6}, Lw5/c;->b(Landroid/content/Context;Landroidx/appcompat/widget/x0;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v1, v3, v10}, Landroidx/appcompat/widget/x0;->j(II)I

    move-result v3

    const/4 v10, 0x0

    invoke-static {v3, v10}, Ls5/t;->d(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-direct {v3, v13, v10}, Landroidx/appcompat/widget/AppCompatTextView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    iput-object v3, v0, Lcom/google/android/material/textfield/TextInputLayout;->M:Landroid/widget/TextView;
    ...
    invoke-static {v3, v11}, Ll0/w$g;->f(Landroid/view/View;I)V
    ...
    invoke-direct {v2, v13, v10}, Landroidx/appcompat/widget/AppCompatTextView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {v2, v3}, Ll0/w$g;->f(Landroid/view/View;I)V
    ...
    invoke-static {v0, v1}, Ll0/w$d;->s(Landroid/view/View;I)V
    ...
    invoke-static {v0, v2}, Ll0/w$l;->l(Landroid/view/View;I)V
...
.method private getEndIconDelegate()Ld6/k;
    .locals 2
...
.method public static s(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V
    ...
    invoke-static {p0}, Ll0/w$c;->a(Landroid/view/View;)Z
...
.method private setEditText(Landroid/widget/EditText;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/TextInputLayout;->U0:Ls5/c;
    ...
    invoke-virtual {v0, v1}, Ls5/c;->p(Landroid/graphics/Typeface;)V
    ...
    iget v2, v0, Ls5/c;->j:F

    cmpl-float v2, v2, v1

    if-eqz v2, :cond_1

    iput v1, v0, Ls5/c;->j:F
    ...
    iget-object v1, p0, Lcom/google/android/material/textfield/TextInputLayout;->U0:Ls5/c;
    ...
    iget v2, v1, Ls5/c;->h:I

    if-eq v2, v0, :cond_2

    iput v0, v1, Ls5/c;->h:I
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/TextInputLayout;->v:Ld6/l;
...
.method private setHintInternal(Ljava/lang/CharSequence;)V
    ...
    iget-object v1, v0, Ls5/c;->x:Ljava/lang/CharSequence;
    ...
    :cond_0
    iput-object p1, v0, Ls5/c;->x:Ljava/lang/CharSequence;

    const/4 p1, 0x0

    iput-object p1, v0, Ls5/c;->y:Ljava/lang/CharSequence;

    iget-object v1, v0, Ls5/c;->A:Landroid/graphics/Bitmap;

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Landroid/graphics/Bitmap;->recycle()V

    iput-object p1, v0, Ls5/c;->A:Landroid/graphics/Bitmap;
...
.method private setPlaceholderTextEnabled(Z)V
    ...
    iput-wide v1, v0, Lk1/h;->p:J

    sget-object v3, Ld5/a;->a:Landroid/animation/TimeInterpolator;

    iput-object v3, v0, Lk1/h;->q:Landroid/animation/TimeInterpolator;

    iput-object v0, p0, Lcom/google/android/material/textfield/TextInputLayout;->H:Lk1/c;

    const-wide/16 v4, 0x43

    iput-wide v4, v0, Lk1/h;->o:J
    ...
    iput-object v0, p0, Lcom/google/android/material/textfield/TextInputLayout;->I:Lk1/c;
...
.method public final A(ZZ)V
    ...
    :goto_1
    iget-object v5, p0, Lcom/google/android/material/textfield/TextInputLayout;->v:Ld6/l;

    invoke-virtual {v5}, Ld6/l;->e()Z
    ...
    iget-object v7, p0, Lcom/google/android/material/textfield/TextInputLayout;->U0:Ls5/c;

    iget-object v8, v7, Ls5/c;->m:Landroid/content/res/ColorStateList;

    if-eq v8, v6, :cond_2

    iput-object v6, v7, Ls5/c;->m:Landroid/content/res/ColorStateList;

    invoke-virtual {v7}, Ls5/c;->j()V

    :cond_2
    iget-object v6, p0, Lcom/google/android/material/textfield/TextInputLayout;->U0:Ls5/c;

    iget-object v7, p0, Lcom/google/android/material/textfield/TextInputLayout;->I0:Landroid/content/res/ColorStateList;

    iget-object v8, v6, Ls5/c;->l:Landroid/content/res/ColorStateList;

    if-eq v8, v7, :cond_3

    iput-object v7, v6, Ls5/c;->l:Landroid/content/res/ColorStateList;

    invoke-virtual {v6}, Ls5/c;->j()V
    ...
    :goto_2
    iget-object v5, p0, Lcom/google/android/material/textfield/TextInputLayout;->U0:Ls5/c;

    invoke-static {v0}, Landroid/content/res/ColorStateList;->valueOf(I)Landroid/content/res/ColorStateList;

    move-result-object v6

    invoke-virtual {v5, v6}, Ls5/c;->l(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v6, v5, Ls5/c;->l:Landroid/content/res/ColorStateList;

    if-eq v6, v0, :cond_9

    iput-object v0, v5, Ls5/c;->l:Landroid/content/res/ColorStateList;

    invoke-virtual {v5}, Ls5/c;->j()V
    ...
    iget-object v5, v5, Ld6/l;->l:Landroid/widget/TextView;
    ...
    :goto_3
    invoke-virtual {v0, v5}, Ls5/c;->l(Landroid/content/res/ColorStateList;)V
    ...
    :goto_4
    invoke-virtual {v5, v0}, Ls5/c;->l(Landroid/content/res/ColorStateList;)V
    ...
    :cond_d
    iget-object p1, p0, Lcom/google/android/material/textfield/TextInputLayout;->U0:Ls5/c;

    invoke-virtual {p1, p2}, Ls5/c;->n(F)V
    ...
    iget-object p1, p0, Lcom/google/android/material/textfield/TextInputLayout;->S:Lz5/f;

    check-cast p1, Ld6/f;

    iget-object p1, p1, Ld6/f;->N:Landroid/graphics/RectF;
    ...
    invoke-virtual {p1, p2, p2, p2, p2}, Ld6/f;->y(FFFF)V
...
.method public final B(I)V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/TextInputLayout;->H:Lk1/c;

    invoke-static {p1, v0}, Lk1/l;->a(Landroid/view/ViewGroup;Lk1/h;)V
...
.method public final C()V
    ...
    invoke-static {v0, v1, v2, v3, v4}, Ll0/w$e;->k(Landroid/view/View;IIII)V
...
.method public final F()V
    ...
    invoke-static {v0}, Ll0/w$e;->e(Landroid/view/View;)I
    ...
    invoke-static {v0, v2, v3, v1, v4}, Ll0/w$e;->k(Landroid/view/View;IIII)V
...
.method public final G()V
    ...
    invoke-direct {p0}, Lcom/google/android/material/textfield/TextInputLayout;->getEndIconDelegate()Ld6/k;

    move-result-object v0

    invoke-virtual {v0, v1}, Ld6/k;->c(Z)V
...
.method public H()V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/TextInputLayout;->S:Lz5/f;
    ...
    :cond_5
    iget-object v4, p0, Lcom/google/android/material/textfield/TextInputLayout;->v:Ld6/l;

    invoke-virtual {v4}, Ld6/l;->e()Z
    ...
    iget-object v1, p0, Lcom/google/android/material/textfield/TextInputLayout;->v:Ld6/l;

    invoke-virtual {v1}, Ld6/l;->e()Z
    ...
    invoke-static {v1}, Lf0/a;->h(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Lcom/google/android/material/textfield/TextInputLayout;->S:Lz5/f;

    check-cast v1, Ld6/f;

    const/4 v4, 0x0

    invoke-virtual {v1, v4, v4, v4, v4}, Ld6/f;->y(FFFF)V
...
.method public b(F)V
    ...
    iget-object v3, p0, Lcom/google/android/material/textfield/TextInputLayout;->U0:Ls5/c;

    iget v3, v3, Ls5/c;->c:F
...
.method public final c()V
    ...
    :cond_0
    iget-object v1, p0, Lcom/google/android/material/textfield/TextInputLayout;->U:Lz5/i;

    invoke-virtual {v0, v1}, Lz5/f;->setShapeAppearanceModel(Lz5/i;)V
    ...
    invoke-virtual {v0, v1, v5}, Lz5/f;->s(FI)V
    ...
    invoke-static {v1, v0, v3}, Lm4/a;->b(Landroid/content/Context;II)I

    move-result v0

    iget v1, p0, Lcom/google/android/material/textfield/TextInputLayout;->f0:I

    invoke-static {v1, v0}, Le0/a;->d(II)I
    ...
    invoke-virtual {v1, v0}, Lz5/f;->q(Landroid/content/res/ColorStateList;)V
    ...
    :cond_5
    iget-object v0, p0, Lcom/google/android/material/textfield/TextInputLayout;->T:Lz5/f;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, v0, Ls5/c;->y:Ljava/lang/CharSequence;

    if-eqz v2, :cond_1

    iget-boolean v2, v0, Ls5/c;->b:Z

    if-eqz v2, :cond_1

    iget-object v2, v0, Ls5/c;->O:Landroid/text/StaticLayout;

    const/4 v3, 0x0

    invoke-virtual {v2, v3}, Landroid/text/StaticLayout;->getLineLeft(I)F

    iget-object v2, v0, Ls5/c;->F:Landroid/text/TextPaint;

    iget v3, v0, Ls5/c;->C:F

    invoke-virtual {v2, v3}, Landroid/text/TextPaint;->setTextSize(F)V

    iget v2, v0, Ls5/c;->r:F

    iget v3, v0, Ls5/c;->s:F

    iget v4, v0, Ls5/c;->B:F
    ...
    iget-object v0, v0, Ls5/c;->O:Landroid/text/StaticLayout;
...
.method public drawableStateChanged()V
    ...
    iget-object v2, p0, Lcom/google/android/material/textfield/TextInputLayout;->U0:Ls5/c;

    const/4 v3, 0x0

    if-eqz v2, :cond_5

    iput-object v1, v2, Ls5/c;->D:[I

    iget-object v1, v2, Ls5/c;->m:Landroid/content/res/ColorStateList;
    ...
    :cond_1
    iget-object v1, v2, Ls5/c;->l:Landroid/content/res/ColorStateList;
...
.method public getBoxBackground()Lz5/f;
    .locals 2
...
.method public getBoxCornerRadiusBottomEnd()F
    ...
    iget-object v1, v1, Lz5/f$b;->a:Lz5/i;

    iget-object v1, v1, Lz5/i;->h:Lz5/c;

    invoke-virtual {v0}, Lz5/f;->i()Landroid/graphics/RectF;

    move-result-object v0

    invoke-interface {v1, v0}, Lz5/c;->a(Landroid/graphics/RectF;)F
...
.method public getBoxCornerRadiusBottomStart()F
    ...
    iget-object v1, v1, Lz5/i;->g:Lz5/c;
...
.method public getBoxCornerRadiusTopEnd()F
    ...
    iget-object v1, v1, Lz5/i;->f:Lz5/c;
...
.method public getError()Ljava/lang/CharSequence;
    ...
    iget-boolean v1, v0, Ld6/l;->k:Z

    if-eqz v1, :cond_0

    iget-object v0, v0, Ld6/l;->j:Ljava/lang/CharSequence;
...
.method public getErrorContentDescription()Ljava/lang/CharSequence;
    ...
    iget-object v0, v0, Ld6/l;->m:Ljava/lang/CharSequence;
...
.method public getHelperText()Ljava/lang/CharSequence;
    ...
    iget-boolean v1, v0, Ld6/l;->q:Z

    if-eqz v1, :cond_0

    iget-object v0, v0, Ld6/l;->p:Ljava/lang/CharSequence;
...
.method public getHelperTextCurrentTextColor()I
    ...
    iget-object v0, v0, Ld6/l;->r:Landroid/widget/TextView;
...
.method public final j(IZ)I
    ...
    iget-object p2, p0, Lcom/google/android/material/textfield/TextInputLayout;->M:Landroid/widget/TextView;
...
.method public final l()V
    ...
    iget-object v1, p0, Lcom/google/android/material/textfield/TextInputLayout;->I:Lk1/c;

    invoke-static {v0, v1}, Lk1/l;->a(Landroid/view/ViewGroup;Lk1/h;)V
...
.method public final n()V
    ...
    iget-object v3, p0, Lcom/google/android/material/textfield/TextInputLayout;->U:Lz5/i;

    invoke-direct {v0, v3}, Ld6/f;-><init>(Lz5/i;)V
    ...
    invoke-direct {v0, v3}, Lz5/f;-><init>(Lz5/i;)V

    :goto_0
    iput-object v0, p0, Lcom/google/android/material/textfield/TextInputLayout;->S:Lz5/f;
    ...
    invoke-direct {v0, v1}, Lz5/f;-><init>(Lz5/i;)V
    ...
    iput-object v0, p0, Lcom/google/android/material/textfield/TextInputLayout;->T:Lz5/f;

    goto :goto_2

    :cond_3
    iput-object v1, p0, Lcom/google/android/material/textfield/TextInputLayout;->S:Lz5/f;

    :goto_1
    iput-object v1, p0, Lcom/google/android/material/textfield/TextInputLayout;->T:Lz5/f;
    ...
    invoke-static {v0}, Lw5/c;->e(Landroid/content/Context;)Z
    ...
    invoke-static {v0}, Lw5/c;->d(Landroid/content/Context;)Z
    ...
    invoke-static {v3}, Ll0/w$e;->e(Landroid/view/View;)I
...
.method public final o()V
    ...
    iget-object v4, v1, Ls5/c;->x:Ljava/lang/CharSequence;

    invoke-virtual {v1, v4}, Ls5/c;->b(Ljava/lang/CharSequence;)Z

    move-result v4

    iput-boolean v4, v1, Ls5/c;->z:Z
    ...
    :cond_4
    iget-object v10, v1, Ls5/c;->f:Landroid/graphics/Rect;
    ...
    iget-object v11, v1, Ls5/c;->f:Landroid/graphics/Rect;
    ...
    invoke-virtual {v1, v2, v3, v4, v0}, Ld6/f;->y(FFFF)V
...
.method public onLayout(ZIIII)V
    ...
    invoke-static {p0, p1, p2}, Ls5/d;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V

    iget-object p1, p0, Lcom/google/android/material/textfield/TextInputLayout;->T:Lz5/f;
    ...
    iget p4, p1, Ls5/c;->j:F

    cmpl-float p4, p4, p3

    if-eqz p4, :cond_1

    iput p3, p1, Ls5/c;->j:F

    invoke-virtual {p1}, Ls5/c;->j()V
    ...
    iget-object p3, p0, Lcom/google/android/material/textfield/TextInputLayout;->U0:Ls5/c;

    and-int/lit8 p4, p1, -0x71

    or-int/lit8 p4, p4, 0x30

    invoke-virtual {p3, p4}, Ls5/c;->m(I)V

    iget-object p3, p0, Lcom/google/android/material/textfield/TextInputLayout;->U0:Ls5/c;

    iget p4, p3, Ls5/c;->h:I

    if-eq p4, p1, :cond_2

    iput p1, p3, Ls5/c;->h:I

    invoke-virtual {p3}, Ls5/c;->j()V
    ...
    sget-object p4, Ll0/w;->a:Ljava/util/WeakHashMap;
    ...
    iget-object v3, p1, Ls5/c;->f:Landroid/graphics/Rect;

    invoke-static {v3, p4, v1, v2, p3}, Ls5/c;->k(Landroid/graphics/Rect;IIII)Z
    ...
    iput-boolean v0, p1, Ls5/c;->E:Z

    invoke-virtual {p1}, Ls5/c;->i()V
    ...
    iget-object p4, p1, Ls5/c;->G:Landroid/text/TextPaint;

    iget v1, p1, Ls5/c;->j:F

    invoke-virtual {p4, v1}, Landroid/text/TextPaint;->setTextSize(F)V

    iget-object v1, p1, Ls5/c;->u:Landroid/graphics/Typeface;
    ...
    iget-object v1, p1, Ls5/c;->e:Landroid/graphics/Rect;

    invoke-static {v1, p4, p5, p3, p2}, Ls5/c;->k(Landroid/graphics/Rect;IIII)Z
...
.method public setCounterEnabled(Z)V
    ...
    invoke-virtual {v0, v2, v1}, Ld6/l;->a(Landroid/widget/TextView;I)V
    ...
    :cond_1
    iget-object v2, p0, Lcom/google/android/material/textfield/TextInputLayout;->v:Ld6/l;

    iget-object v3, p0, Lcom/google/android/material/textfield/TextInputLayout;->z:Landroid/widget/TextView;

    invoke-virtual {v2, v3, v1}, Ld6/l;->j(Landroid/widget/TextView;I)V
...
.method public setEndIconMode(I)V
    ...
    invoke-virtual {v0, v1}, Ld6/k;->b(I)Z
...
.method public setError(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0}, Ld6/l;->c()V

    iput-object p1, v0, Ld6/l;->j:Ljava/lang/CharSequence;

    iget-object v2, v0, Ld6/l;->l:Landroid/widget/TextView;

    invoke-virtual {v2, p1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget v2, v0, Ld6/l;->h:I

    if-eq v2, v1, :cond_2

    iput v1, v0, Ld6/l;->i:I

    :cond_2
    iget v1, v0, Ld6/l;->i:I

    iget-object v3, v0, Ld6/l;->l:Landroid/widget/TextView;

    invoke-virtual {v0, v3, p1}, Ld6/l;->k(Landroid/widget/TextView;Ljava/lang/CharSequence;)Z

    move-result p1

    invoke-virtual {v0, v2, v1, p1}, Ld6/l;->l(IIZ)V

    goto :goto_0

    :cond_3
    iget-object p1, p0, Lcom/google/android/material/textfield/TextInputLayout;->v:Ld6/l;

    invoke-virtual {p1}, Ld6/l;->i()V
...
.method public setErrorContentDescription(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, v0, Ld6/l;->m:Ljava/lang/CharSequence;

    iget-object v0, v0, Ld6/l;->l:Landroid/widget/TextView;
...
.method public setErrorEnabled(Z)V
    ...
    iget-object v4, v0, Ld6/l;->a:Landroid/content/Context;
    ...
    iput-object v3, v0, Ld6/l;->l:Landroid/widget/TextView;

    const v1, 0x7f0a02b1

    invoke-virtual {v3, v1}, Landroid/widget/TextView;->setId(I)V

    iget-object v1, v0, Ld6/l;->l:Landroid/widget/TextView;

    const/4 v3, 0x5

    invoke-virtual {v1, v3}, Landroid/widget/TextView;->setTextAlignment(I)V

    iget-object v1, v0, Ld6/l;->u:Landroid/graphics/Typeface;
    ...
    :cond_1
    iget v1, v0, Ld6/l;->n:I

    iput v1, v0, Ld6/l;->n:I

    iget-object v3, v0, Ld6/l;->l:Landroid/widget/TextView;

    if-eqz v3, :cond_2

    iget-object v4, v0, Ld6/l;->b:Lcom/google/android/material/textfield/TextInputLayout;

    invoke-virtual {v4, v3, v1}, Lcom/google/android/material/textfield/TextInputLayout;->t(Landroid/widget/TextView;I)V

    :cond_2
    iget-object v1, v0, Ld6/l;->o:Landroid/content/res/ColorStateList;

    iput-object v1, v0, Ld6/l;->o:Landroid/content/res/ColorStateList;
    ...
    :cond_3
    iget-object v1, v0, Ld6/l;->m:Ljava/lang/CharSequence;

    iput-object v1, v0, Ld6/l;->m:Ljava/lang/CharSequence;
    ...
    invoke-static {v1, v3}, Ll0/w$g;->f(Landroid/view/View;I)V

    iget-object v1, v0, Ld6/l;->l:Landroid/widget/TextView;

    invoke-virtual {v0, v1, v2}, Ld6/l;->a(Landroid/widget/TextView;I)V

    goto :goto_0

    :cond_5
    invoke-virtual {v0}, Ld6/l;->i()V

    iget-object v3, v0, Ld6/l;->l:Landroid/widget/TextView;

    invoke-virtual {v0, v3, v2}, Ld6/l;->j(Landroid/widget/TextView;I)V

    iput-object v1, v0, Ld6/l;->l:Landroid/widget/TextView;

    iget-object v1, v0, Ld6/l;->b:Lcom/google/android/material/textfield/TextInputLayout;
...
.method public setErrorTextAppearance(I)V
    ...
    iput p1, v0, Ld6/l;->n:I

    iget-object v1, v0, Ld6/l;->l:Landroid/widget/TextView;

    if-eqz v1, :cond_0

    iget-object v0, v0, Ld6/l;->b:Lcom/google/android/material/textfield/TextInputLayout;
...
.method public setErrorTextColor(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, v0, Ld6/l;->o:Landroid/content/res/ColorStateList;
...
.method public setHelperText(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, v0, Ld6/l;->p:Ljava/lang/CharSequence;

    iget-object v1, v0, Ld6/l;->r:Landroid/widget/TextView;

    invoke-virtual {v1, p1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget v1, v0, Ld6/l;->h:I

    const/4 v2, 0x2

    if-eq v1, v2, :cond_2

    iput v2, v0, Ld6/l;->i:I

    :cond_2
    iget v2, v0, Ld6/l;->i:I

    iget-object v3, v0, Ld6/l;->r:Landroid/widget/TextView;

    invoke-virtual {v0, v3, p1}, Ld6/l;->k(Landroid/widget/TextView;Ljava/lang/CharSequence;)Z

    move-result p1

    invoke-virtual {v0, v1, v2, p1}, Ld6/l;->l(IIZ)V
...
.method public setHelperTextColor(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, v0, Ld6/l;->t:Landroid/content/res/ColorStateList;
...
.method public setHelperTextEnabled(Z)V
    ...
    iput-object v3, v0, Ld6/l;->r:Landroid/widget/TextView;

    const v2, 0x7f0a02b2

    invoke-virtual {v3, v2}, Landroid/widget/TextView;->setId(I)V

    iget-object v2, v0, Ld6/l;->r:Landroid/widget/TextView;

    const/4 v3, 0x5

    invoke-virtual {v2, v3}, Landroid/widget/TextView;->setTextAlignment(I)V

    iget-object v2, v0, Ld6/l;->u:Landroid/graphics/Typeface;
    ...
    invoke-static {v2, v1}, Ll0/w$g;->f(Landroid/view/View;I)V

    iget v2, v0, Ld6/l;->s:I

    iput v2, v0, Ld6/l;->s:I

    iget-object v3, v0, Ld6/l;->r:Landroid/widget/TextView;

    if-eqz v3, :cond_2

    invoke-static {v3, v2}, Lo0/h;->f(Landroid/widget/TextView;I)V

    :cond_2
    iget-object v2, v0, Ld6/l;->t:Landroid/content/res/ColorStateList;

    iput-object v2, v0, Ld6/l;->t:Landroid/content/res/ColorStateList;
    ...
    iput v4, v0, Ld6/l;->i:I

    :cond_5
    iget v4, v0, Ld6/l;->i:I

    iget-object v5, v0, Ld6/l;->r:Landroid/widget/TextView;

    invoke-virtual {v0, v5, v2}, Ld6/l;->k(Landroid/widget/TextView;Ljava/lang/CharSequence;)Z

    move-result v5

    invoke-virtual {v0, v3, v4, v5}, Ld6/l;->l(IIZ)V

    iget-object v3, v0, Ld6/l;->r:Landroid/widget/TextView;

    invoke-virtual {v0, v3, v1}, Ld6/l;->j(Landroid/widget/TextView;I)V

    iput-object v2, v0, Ld6/l;->r:Landroid/widget/TextView;
...
.method public setHelperTextTextAppearance(I)V
    ...
    iput p1, v0, Ld6/l;->s:I

    iget-object v0, v0, Ld6/l;->r:Landroid/widget/TextView;

    if-eqz v0, :cond_0

    invoke-static {v0, p1}, Lo0/h;->f(Landroid/widget/TextView;I)V
...
.method public setHintTextAppearance(I)V
    ...
    iget-object v2, v0, Ls5/c;->a:Landroid/view/View;

    invoke-virtual {v2}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-direct {v1, v2, p1}, Lw5/d;-><init>(Landroid/content/Context;I)V

    iget-object p1, v1, Lw5/d;->j:Landroid/content/res/ColorStateList;

    if-eqz p1, :cond_0

    iput-object p1, v0, Ls5/c;->m:Landroid/content/res/ColorStateList;

    :cond_0
    iget p1, v1, Lw5/d;->k:F
    ...
    iput p1, v0, Ls5/c;->k:F

    :cond_1
    iget-object p1, v1, Lw5/d;->a:Landroid/content/res/ColorStateList;
    ...
    :cond_2
    iget p1, v1, Lw5/d;->e:F

    iput p1, v0, Ls5/c;->K:F

    iget p1, v1, Lw5/d;->f:F

    iput p1, v0, Ls5/c;->L:F

    iget p1, v1, Lw5/d;->g:F

    iput p1, v0, Ls5/c;->J:F

    iget p1, v1, Lw5/d;->i:F

    iput p1, v0, Ls5/c;->N:F

    iget-object p1, v0, Ls5/c;->w:Lw5/a;

    if-eqz p1, :cond_3

    const/4 v2, 0x1

    iput-boolean v2, p1, Lw5/a;->c:Z
    ...
    invoke-direct {v2, v0}, Ls5/b;-><init>(Ls5/c;)V

    invoke-virtual {v1}, Lw5/d;->a()V

    iget-object v3, v1, Lw5/d;->n:Landroid/graphics/Typeface;

    invoke-direct {p1, v2, v3}, Lw5/a;-><init>(Lw5/a$a;Landroid/graphics/Typeface;)V

    iput-object p1, v0, Ls5/c;->w:Lw5/a;

    iget-object p1, v0, Ls5/c;->a:Landroid/view/View;

    invoke-virtual {p1}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p1

    iget-object v2, v0, Ls5/c;->w:Lw5/a;

    invoke-virtual {v1, p1, v2}, Lw5/d;->c(Landroid/content/Context;Lw5/f;)V

    invoke-virtual {v0}, Ls5/c;->j()V

    iget-object p1, p0, Lcom/google/android/material/textfield/TextInputLayout;->U0:Ls5/c;

    iget-object p1, p1, Ls5/c;->m:Landroid/content/res/ColorStateList;
...
.method public setHintTextColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Ls5/c;->m:Landroid/content/res/ColorStateList;
...
.method public setTextInputAccessibilityDelegate(Lcom/google/android/material/textfield/TextInputLayout$e;)V
    ...
    invoke-static {v0, p1}, Ll0/w;->v(Landroid/view/View;Ll0/a;)V
...
.method public setTypeface(Landroid/graphics/Typeface;)V
    ...
    invoke-virtual {v0, p1}, Ls5/c;->p(Landroid/graphics/Typeface;)V
    ...
    iput-object p1, v0, Ld6/l;->u:Landroid/graphics/Typeface;
...
.method public t(Landroid/widget/TextView;I)V
    ...
    invoke-static {p2, v0}, Lc0/a;->b(Landroid/content/Context;I)I
...
.method public v(I)V
    ...
    iget-object v6, v1, Lj0/a;->c:Lj0/c;
    ...
    :cond_4
    invoke-virtual {v1, p1, v6, v4}, Lj0/a;->d(Ljava/lang/CharSequence;Lj0/c;Z)Ljava/lang/CharSequence;
...
.method public final x()Z
    ...
    :cond_7
    iget-object v6, p0, Lcom/google/android/material/textfield/TextInputLayout;->N:Ljava/lang/CharSequence;
