...
# direct methods
.method public constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILz5/i;Landroid/graphics/Rect;)V
    .locals 1
    ...
    iput-object p5, p0, Lcom/google/android/material/datepicker/b;->f:Lz5/i;
...
.method public static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/b;
    ...
    invoke-static {v2, v3}, Le/d;->a(ZLjava/lang/Object;)V

    sget-object v2, Lc5/a;->q:[I
    ...
    invoke-static {p0, p1, v1}, Lw5/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {v3, v0}, Lz5/a;-><init>(F)V

    invoke-static {p0, v1, v2, v3}, Lz5/i;->a(Landroid/content/Context;IILz5/c;)Lz5/i$b;

    move-result-object p0

    invoke-virtual {p0}, Lz5/i$b;->a()Lz5/i;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/b;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILz5/i;Landroid/graphics/Rect;)V
...
.method public b(Landroid/widget/TextView;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lz5/i;

    invoke-virtual {v0, v2}, Lz5/f;->setShapeAppearanceModel(Lz5/i;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lz5/i;

    invoke-virtual {v1, v2}, Lz5/f;->setShapeAppearanceModel(Lz5/i;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->c:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, v2}, Lz5/f;->q(Landroid/content/res/ColorStateList;)V
