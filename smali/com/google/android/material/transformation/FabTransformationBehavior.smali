...
.method public u(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    invoke-static/range {p2 .. p2}, Ll0/w$i;->i(Landroid/view/View;)F

    move-result v7

    invoke-static/range {p1 .. p1}, Ll0/w$i;->i(Landroid/view/View;)F
    ...
    :goto_0
    iget-object v11, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Ld5/g;

    const-string v12, "elevation"

    invoke-virtual {v11, v12}, Ld5/g;->d(Ljava/lang/String;)Ld5/h;

    move-result-object v11

    invoke-virtual {v11, v7}, Ld5/h;->a(Landroid/animation/Animator;)V
    ...
    iget-object v11, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Ld5/i;

    invoke-virtual {v0, v1, v2, v11}, Lcom/google/android/material/transformation/FabTransformationBehavior;->w(Landroid/view/View;Landroid/view/View;Ld5/i;)F

    move-result v11

    iget-object v12, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Ld5/i;

    invoke-virtual {v0, v1, v2, v12}, Lcom/google/android/material/transformation/FabTransformationBehavior;->x(Landroid/view/View;Landroid/view/View;Ld5/i;)F
    ...
    invoke-virtual {v0, v4, v14, v11, v8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->y(Lcom/google/android/material/transformation/FabTransformationBehavior$b;Ld5/h;FF)F

    move-result v11

    invoke-virtual {v0, v4, v13, v12, v8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->y(Lcom/google/android/material/transformation/FabTransformationBehavior$b;Ld5/h;FF)F
    ...
    :goto_1
    invoke-virtual {v14, v6}, Ld5/h;->a(Landroid/animation/Animator;)V

    invoke-virtual {v13, v8}, Ld5/h;->a(Landroid/animation/Animator;)V
    ...
    iget-object v8, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Ld5/i;

    invoke-virtual {v0, v1, v2, v8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->w(Landroid/view/View;Landroid/view/View;Ld5/i;)F

    move-result v8

    iget-object v11, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Ld5/i;

    invoke-virtual {v0, v1, v2, v11}, Lcom/google/android/material/transformation/FabTransformationBehavior;->x(Landroid/view/View;Landroid/view/View;Ld5/i;)F
    ...
    invoke-virtual {v12, v11}, Ld5/h;->a(Landroid/animation/Animator;)V

    invoke-virtual {v5, v8}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v5, v11}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    instance-of v8, v2, Ll5/d;
    ...
    :cond_9
    sget-object v13, Ld5/d;->a:Landroid/util/Property;
    ...
    :cond_a
    sget-object v14, Ld5/d;->a:Landroid/util/Property;
    ...
    iget-object v14, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Ld5/g;

    const-string v15, "iconFade"

    invoke-virtual {v14, v15}, Ld5/g;->d(Ljava/lang/String;)Ld5/h;

    move-result-object v14

    invoke-virtual {v14, v13}, Ld5/h;->a(Landroid/animation/Animator;)V

    invoke-virtual {v5, v13}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    new-instance v13, Lcom/google/android/material/transformation/b;

    invoke-direct {v13, v0, v11, v12}, Lcom/google/android/material/transformation/b;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Ll5/d;Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v13, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Ld5/i;
    ...
    invoke-virtual {v0, v1, v2, v13}, Lcom/google/android/material/transformation/FabTransformationBehavior;->w(Landroid/view/View;Landroid/view/View;Ld5/i;)F
    ...
    iget-object v10, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Ld5/i;
    ...
    invoke-virtual {v0, v1, v2, v10}, Lcom/google/android/material/transformation/FabTransformationBehavior;->x(Landroid/view/View;Landroid/view/View;Ld5/i;)F
    ...
    iget-object v13, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Ld5/g;

    const-string v14, "expansion"

    invoke-virtual {v13, v14}, Ld5/g;->d(Ljava/lang/String;)Ld5/h;
    ...
    new-instance v14, Ll5/d$e;

    invoke-direct {v14, v9, v8, v10}, Ll5/d$e;-><init>(FFF)V

    invoke-interface {v12, v14}, Ll5/d;->setRevealInfo(Ll5/d$e;)V

    :cond_d
    if-eqz p4, :cond_e

    invoke-interface {v12}, Ll5/d;->getRevealInfo()Ll5/d$e;

    move-result-object v10

    iget v10, v10, Ll5/d$e;->c:F

    :cond_e
    const/4 v14, 0x0

    invoke-static {v9, v8, v14, v14}, Lm4/a;->a(FFFF)F

    move-result v15

    invoke-static {v9, v8, v6, v14}, Lm4/a;->a(FFFF)F

    move-result v21

    invoke-static {v9, v8, v6, v7}, Lm4/a;->a(FFFF)F

    move-result v6

    invoke-static {v9, v8, v14, v7}, Lm4/a;->a(FFFF)F
    ...
    :goto_7
    invoke-static {v12, v9, v8, v15}, Ll5/b;->a(Ll5/d;FFF)Landroid/animation/Animator;

    move-result-object v6

    new-instance v7, Lcom/google/android/material/transformation/c;

    invoke-direct {v7, v0, v12}, Lcom/google/android/material/transformation/c;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Ll5/d;)V

    invoke-virtual {v6, v7}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    iget-wide v14, v13, Ld5/h;->a:J
    ...
    iget v0, v0, Ll5/d$e;->c:F

    invoke-static {v12, v9, v8, v10}, Ll5/b;->a(Ll5/d;FFF)Landroid/animation/Animator;
    ...
    iget-wide v8, v13, Ld5/h;->b:J

    iget-object v0, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Ld5/g;

    move-object/from16 v21, v6

    iget-object v6, v0, Ld5/g;->a:Lr/h;
    ...
    invoke-virtual {v6, v11}, Lr/h;->k(I)Ljava/lang/Object;
    ...
    iget-wide v12, v6, Ld5/h;->a:J

    move-object/from16 v25, v5

    iget-wide v5, v6, Ld5/h;->b:J
    ...
    :goto_a
    invoke-virtual {v0, v6}, Ld5/h;->a(Landroid/animation/Animator;)V
    ...
    invoke-direct {v0, v3}, Ll5/a;-><init>(Ll5/d;)V
    ...
    invoke-static/range {p1 .. p1}, Ll0/w$i;->g(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    invoke-interface {v0, v4}, Ll5/d;->setCircularRevealScrimColor(I)V

    :cond_19
    sget-object v4, Ll5/d$d;->a:Landroid/util/Property;
    ...
    sget-object v5, Ll5/d$d;->a:Landroid/util/Property;
    ...
    iget-object v5, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Ld5/g;

    const-string v7, "color"

    invoke-virtual {v5, v7}, Ld5/g;->d(Ljava/lang/String;)Ld5/h;

    move-result-object v5

    invoke-virtual {v5, v0}, Ld5/h;->a(Landroid/animation/Animator;)V
    ...
    :cond_1c
    instance-of v0, v2, Lf6/b;

    if-nez v0, :cond_1e

    instance-of v0, v2, Lf6/a;
    ...
    sget-object v7, Ld5/c;->a:Landroid/util/Property;
    ...
    :goto_13
    iget-object v4, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Ld5/g;

    const-string v7, "contentFade"

    invoke-virtual {v4, v7}, Ld5/g;->d(Ljava/lang/String;)Ld5/h;

    move-result-object v4

    invoke-virtual {v4, v0}, Ld5/h;->a(Landroid/animation/Animator;)V
    ...
    invoke-static {v0, v1}, Le/k;->d(Landroid/animation/AnimatorSet;Ljava/util/List;)V
...
.method public final v(FFZLcom/google/android/material/transformation/FabTransformationBehavior$b;)Landroid/util/Pair;
    ...
    :cond_2
    iget-object p1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Ld5/g;

    const-string p2, "translationXCurveUpwards"

    invoke-virtual {p1, p2}, Ld5/g;->d(Ljava/lang/String;)Ld5/h;

    move-result-object p1

    iget-object p2, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Ld5/g;
    ...
    :goto_1
    invoke-virtual {p2, p3}, Ld5/g;->d(Ljava/lang/String;)Ld5/h;
...
.method public final w(Landroid/view/View;Landroid/view/View;Ld5/i;)F
    .locals 3
...
.method public final x(Landroid/view/View;Landroid/view/View;Ld5/i;)F
    .locals 3
...
.method public final y(Lcom/google/android/material/transformation/FabTransformationBehavior$b;Ld5/h;FF)F
    .locals 8

    iget-wide v0, p2, Ld5/h;->a:J

    iget-wide v2, p2, Ld5/h;->b:J

    iget-object p1, p1, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Ld5/g;

    const-string v4, "expansion"

    invoke-virtual {p1, v4}, Ld5/g;->d(Ljava/lang/String;)Ld5/h;

    move-result-object p1

    iget-wide v4, p1, Ld5/h;->a:J

    iget-wide v6, p1, Ld5/h;->b:J
    ...
    invoke-virtual {p2}, Ld5/h;->b()Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p3, p4, p1}, Ld5/a;->a(FFF)F
