...
# direct methods
.method public constructor <init>(Ls8/f$a;)V
    .locals 0

    invoke-direct {p0}, Landroidx/recyclerview/widget/p$d;-><init>()V

    iput-object p1, p0, Ls8/f;->d:Ls8/f$a;

    const/4 p1, -0x1

    iput p1, p0, Ls8/f;->e:I

    iput p1, p0, Ls8/f;->f:I
...
.method public a(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$b0;Landroidx/recyclerview/widget/RecyclerView$b0;)Z
    ...
    const-string p2, "null cannot be cast to non-null type com.tombayley.statusbar.app.ui.sliders.recyclerview.SlidersListAdapter"
    ...
    invoke-virtual {p1}, Ls8/e;->s()Ljava/util/List;
    ...
    iget-object p1, p1, Ls8/a;->a:Ljava/lang/Object;

    instance-of p2, p1, Lcom/tombayley/statusbar/app/ui/sliders/SlidersReorderActivity$a;

    if-eqz p2, :cond_1

    sget-object p2, Lcom/tombayley/statusbar/app/ui/sliders/SlidersReorderActivity$a;->n:Lcom/tombayley/statusbar/app/ui/sliders/SlidersReorderActivity$a;
...
.method public b(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$b0;)V
    ...
    iget-object v1, p0, Ls8/f;->d:Ls8/f$a;

    invoke-interface {v1, p1, v0}, Ls8/f$a;->b(II)V

    :cond_0
    iput p2, p0, Ls8/f;->f:I

    iput p2, p0, Ls8/f;->e:I
...
.method public i(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$b0;Landroidx/recyclerview/widget/RecyclerView$b0;)Z
    ...
    iget-object p3, p0, Ls8/f;->d:Ls8/f$a;

    invoke-interface {p3, p1, p2}, Ls8/f$a;->c(II)V
...
.method public j(Landroidx/recyclerview/widget/RecyclerView$b0;I)V
    ...
    iget-object p2, p0, Ls8/f;->d:Ls8/f$a;

    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$b0;->f()I

    move-result p1

    invoke-interface {p2, p1}, Ls8/f$a;->a(I)V
