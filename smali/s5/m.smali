...
.method public constructor <init>(Ljava/lang/CharSequence;Landroid/text/TextPaint;I)V
    ...
    iput-object p1, p0, Ls5/m;->a:Ljava/lang/CharSequence;

    iput-object p2, p0, Ls5/m;->b:Landroid/text/TextPaint;

    iput p3, p0, Ls5/m;->c:I
    ...
    iput-object p1, p0, Ls5/m;->e:Landroid/text/Layout$Alignment;

    const p1, 0x7fffffff

    iput p1, p0, Ls5/m;->f:I

    const/4 p1, 0x0

    iput p1, p0, Ls5/m;->g:F

    const/high16 p1, 0x3f800000    # 1.0f

    iput p1, p0, Ls5/m;->h:F
    ...
    iput-boolean p1, p0, Ls5/m;->j:Z

    const/4 p1, 0x0

    iput-object p1, p0, Ls5/m;->l:Landroid/text/TextUtils$TruncateAt;
...
.method public a()Landroid/text/StaticLayout;
    ...
    iget-object v0, v1, Ls5/m;->a:Ljava/lang/CharSequence;

    if-nez v0, :cond_0

    const-string v0, ""

    iput-object v0, v1, Ls5/m;->a:Ljava/lang/CharSequence;

    :cond_0
    iget v0, v1, Ls5/m;->c:I
    ...
    iget-object v3, v1, Ls5/m;->a:Ljava/lang/CharSequence;

    iget v4, v1, Ls5/m;->f:I

    const/4 v5, 0x1

    if-ne v4, v5, :cond_1

    iget-object v4, v1, Ls5/m;->b:Landroid/text/TextPaint;

    int-to-float v6, v0

    iget-object v7, v1, Ls5/m;->l:Landroid/text/TextUtils$TruncateAt;
    ...
    iget v6, v1, Ls5/m;->d:I

    invoke-static {v4, v6}, Ljava/lang/Math;->min(II)I

    move-result v4

    iput v4, v1, Ls5/m;->d:I
    ...
    iget-boolean v6, v1, Ls5/m;->k:Z

    if-eqz v6, :cond_2

    iget v6, v1, Ls5/m;->f:I

    if-ne v6, v5, :cond_2

    sget-object v6, Landroid/text/Layout$Alignment;->ALIGN_OPPOSITE:Landroid/text/Layout$Alignment;

    iput-object v6, v1, Ls5/m;->e:Landroid/text/Layout$Alignment;

    :cond_2
    iget-object v6, v1, Ls5/m;->b:Landroid/text/TextPaint;
    ...
    iget-object v2, v1, Ls5/m;->e:Landroid/text/Layout$Alignment;
    ...
    iget-object v2, v1, Ls5/m;->l:Landroid/text/TextUtils$TruncateAt;
    ...
    :goto_2
    sput-object v4, Ls5/m;->p:Ljava/lang/Object;
    ...
    sput-object v4, Ls5/m;->o:Ljava/lang/reflect/Constructor;

    invoke-virtual {v4, v5}, Ljava/lang/reflect/Constructor;->setAccessible(Z)V

    sput-boolean v5, Ls5/m;->n:Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_1

    :goto_3
    :try_start_1
    sget-object v4, Ls5/m;->o:Ljava/lang/reflect/Constructor;
    ...
    iget-object v2, v1, Ls5/m;->b:Landroid/text/TextPaint;
    ...
    sget-object v2, Ls5/m;->p:Ljava/lang/Object;
    ...
    invoke-direct {v2, v0}, Ls5/m$a;-><init>(Ljava/lang/Throwable;)V
